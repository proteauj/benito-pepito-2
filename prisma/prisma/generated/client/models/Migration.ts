...
export type MigrationWhereInput = {
  ...
  executedAt?: Prisma.DateTimeFilter<"Migration"> | Date | string
}
...
export type MigrationScalarWhereWithAggregatesInput = {
  ...
  executedAt?: Prisma.DateTimeWithAggregatesFilter<"Migration"> | Date | string
}
...
export type MigrationOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "name" | "executedAt", ExtArgs["result"]["migration"]>
...
export interface MigrationFieldRefs {
  ...
  readonly executedAt: Prisma.FieldRef<"Migration", 'DateTime'>
}
